...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //职位类型
        _zwKindText = [self addLabelWithFrame:CGRectMake(_hMainImage.x+_hMainImage.width+10, _hMainImage.y, topView.width/3, _hMainImage.height/4) andTextColor:HWColor(51, 51, 51) andTextSize:18 andTextAlignment:NSTextAlignmentLeft andsView:topView];
        //薪资
        _salaryText = [self addLabelWithFrame:CGRectMake(topView.width*7/8, _zwKindText.y, topView.width/8-10, _zwKindText.height) andTextColor:HWColor(255, 152, 23) andTextSize:18 andTextAlignment:NSTextAlignmentLeft andsView:topView];
        
        //公司
        _companyText = [self addLabelWithFrame:CGRectMake(_zwKindText.x, _zwKindText.y+_zwKindText.height, SCREEN_WIDTH*2/7, _zwKindText.height) andTextColor:HWColor(102, 102, 102) andTextSize:15 andTextAlignment:NSTextAlignmentLeft andsView:topView];
        //vip
        ...
        //行业类型
        _hyText = [self addLabelWithFrame:CGRectMake(_vipImage.x+_vipImage.width+5, _vipImage.y, topView.width/9, _vipImage.height) andTextColor:HWColor(153, 153, 153) andTextSize:15 andTextAlignment:NSTextAlignmentLeft andsView:topView];
        ...
        //是否上市
        _bigCompanyText = [self addLabelWithFrame:CGRectMake(line.x+line.width, _hyText.y, topView.width/8, _hyText.height) andTextColor:HWColor(153, 153, 153) andTextSize:15 andTextAlignment:NSTextAlignmentCenter andsView:topView];
        //学历照片
        ...
        //学历
        _academicText = [self addLabelWithFrame:CGRectMake(_academicImage.x+_academicImage.width+2, _companyText.y+_companyText.height, topView.width/11, _companyText.height) andTextColor:HWColor(153, 153, 153) andTextSize:15 andTextAlignment:NSTextAlignmentLeft andsView:topView];
