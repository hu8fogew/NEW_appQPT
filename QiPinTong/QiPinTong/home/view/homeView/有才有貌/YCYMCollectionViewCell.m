...
-(id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.titleLabel = [self addLabelWithFont:15 andTextColor:[UIColor whiteColor] andSview:self.imgView];
        ...
        self.jobLabel = [self addLabelWithFont:13 andTextColor:[UIColor whiteColor] andSview:self.imgView];
        ...
        self.educaLabel = [self addLabelWithFont:13 andTextColor:HWColor(153, 153, 153) andSview:vi];
