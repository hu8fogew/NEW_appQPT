...
- (void)setTitleArray:(NSArray *)titleArray {
    ...
    for (int i = 0; i < objArray.count; i++) {
        ...
        AdView *tableAdView = [[AdView alloc]init];
...
//
        ...
        [tableAdView setMainQues:objArray[i][@"mainTitle"] andComment:objArray[i][@"commentTitle"]];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (self.ccpScrollView.contentOffset.y > self.ccpScrollView.frame.size.height*(self.titleArray.count )-12) {
