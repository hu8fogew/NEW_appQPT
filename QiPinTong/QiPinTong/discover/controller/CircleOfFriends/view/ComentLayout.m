...
-(id)initCommentCell
{
    ...
    if (self) {
        ...
        //评论
        LWTextStorage *comment = [self createTextWithTextColor:SecondTitleColor andTextFont:MainAnswerFont andFrame:CGRectMake(image.left, image.bottom+10, SCREEN_WIDTH-leftToMargin*2, CGFLOAT_MAX)];
