...
-(void)createAdsPageWithArr:(NSMutableArray *)source
{
    ...
    [aut createCaruselWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, lunBoheight) WithSuperView:self.headerView WithImageUrlArr:arr WithPlaceholderImageName:@"tb" WithInterval:2];
