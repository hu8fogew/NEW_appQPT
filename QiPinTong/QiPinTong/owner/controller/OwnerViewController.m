...
-(void)setupFrame{
   ...
   //账号
    ...
    [loginBtn setBackgroundColor:HWColor(10, 157, 225)];
    ...
    [retrievePwd setTitleColor:HWColor(91, 85, 132) forState:UIControlStateNormal];
    ...
    [registerBtn setTitleColor:HWColor(91, 85, 132) forState:UIControlStateNormal];
