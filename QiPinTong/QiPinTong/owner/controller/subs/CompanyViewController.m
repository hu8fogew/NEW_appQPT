...
-(UIView *)showView{
    if (!_showView) {
        ...
        CompanyShowView *vi = [[CompanyShowView alloc]initWithFrame:_showView.bounds];
        vi.focusNoLabel.text = @"10";
        vi.funsNoLabel.text = @"50";
        vi.jobNoLabel.text = @"20";
        vi.resumeNoLabel.text = @"100";
        ...
        UITapGestureRecognizer *tapGesture4 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(fourthViewClick)];
        [vi.fourthView addGestureRecognizer:tapGesture4];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        if (indexPath.row == 0) {
            ...
            cell.icon.image = [UIImage imageNamed:@"love"];
            cell.title.text = @"我的收支";
        }
        else{
            cell.icon.image = [UIImage imageNamed:@""];
            cell.title.text = @"我的通币";
        }
    }
